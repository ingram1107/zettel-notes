...
[substitution](202209281136.md)# will be done on the data with 8 S-boxes (which
is the backbone for the DES security guarantees) that map 6 to 4 bits producing
a 32-bit data which feed it to another permutation (XOR with the left half
later).
...
[Secure Electronic Transaction (SET)](202212052200.md)# and
