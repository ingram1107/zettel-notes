...
size and layout. At maximum range, there is a sharp cut-off due to the limits on
receiver sensitivity and background noises. Background noises can come from
ambient lighting (sunlight and artificial incandescent light), heaters, water
vapour, particulate contamination etc.
...
IR WLAN typically layout by placing all transmitters and receivers higher than
about 2.5 meters (avoid interference from objects). Then, they direct all
signals at the ceiling. Lastly, they aim all signals at a single point on the
ceiling or satellite.
